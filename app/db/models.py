...
class Job(Base):
    ...
    parsed_data = Column(Text)  # JSON as Text for SQLite
...
class Project(Base):
    ...
    tech_stack = Column(Text)  # JSON array as Text
    link = Column(Text)
    is_autogenerated = Column(Boolean, default=False)
    metadata_json = Column(Text)  # JSON as Text
...
class Application(Base):
    ...
    response_data = Column(Text)  # JSON as Text
